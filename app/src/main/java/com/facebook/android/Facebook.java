...
public class Facebook
{
    ...
    private class SetterTokenCachingStrategy extends TokenCachingStrategy
    {
        ...
        public Bundle load()
        {
            ...
            if(accessToken != null)
            {
                ...
                TokenCachingStrategy.putPermissions(bundle, (ArrayList)Facebook.stringList(pendingAuthorizationPermissions));
    ...
    private static class TokenRefreshConnectionHandler extends Handler
    {
        ...
        public void handleMessage(Message message)
        {
            ...
            if(s1 == null) {
                if(tokenrefreshserviceconnection.serviceListener != null)
                {
                    ...
                    } else
                    {
                        ...
                        if(s != null)
                            ...
                            temp0 = "Unknown service error";
                        servicelistener.onError(new Error(temp0));
                    }
                }
            } else {
                ...
                if (tokenrefreshserviceconnection.serviceListener != null) {
                    Bundle temp = (Bundle) message.getData().clone();
                    temp.putLong("expires_in", l);
                    tokenrefreshserviceconnection.serviceListener.onComplete(temp);
                }
            }
    ...
    private void authorize(Activity activity, String as[], int i, SessionLoginBehavior sessionloginbehavior, final DialogListener listener)
    {
        ...
        Session.StatusCallback temp = new com.facebook.Session.StatusCallback() {
        ...
        Session.OpenRequest temp2 = (new com.facebook.Session.OpenRequest(activity)).setCallback(temp).setLoginBehavior(sessionloginbehavior).setRequestCode(i).setPermissions(Arrays.asList(pendingAuthorizationPermissions));


        if(pendingAuthorizationPermissions.length > 0)
            flag = true;
        openSession(pendingOpeningSession, temp2, flag);
    }
    ...
    private boolean validateAppSignatureForPackage(Context context, String s)
    {
        ...
        try
        {
            PackageInfo temp = context.getPackageManager().getPackageInfo(s, 64);
            Signature temp2[] = ((PackageInfo) (temp)).signatures;
            j = temp2.length;
            i = 0;
            boolean flag = flag1;
            for(;i < j;i++)
            {
                if(temp2[i].toCharsString().equals("")) {
                    flag = true;
                    return flag;
                }
            }
    ...
    {
        ResolveInfo temp = context.getPackageManager().resolveService(intent, 0);
        if(intent == null)
            return false;
        else
            return validateAppSignatureForPackage(context, (temp.serviceInfo.packageName));
    }
    ...
    public boolean extendAccessToken(Context context, ServiceListener servicelistener)
    {
        ...
        if(!validateServiceIntent(context, intent))
            ...
            return context.bindService(intent, new TokenRefreshServiceConnection(context, servicelistener), Context.BIND_IMPORTANT); //1
    }
    ...
    public final Session getSession()
    {
        ...
        if(session2.getState() != SessionState.CREATED_TOKEN_LOADED)
            return null;
        Session.OpenRequest temp = (new com.facebook.Session.OpenRequest(pendingAuthorizationActivity)).setPermissions(((List) (obj1)));
        ...
        if(!((List) (obj1)).isEmpty())
            ...
            flag = false;
        openSession(session2, temp, flag);
        obj1 = null;
        obj3 = lock;
        ...
        throws MalformedURLException, IOException
    {
        ...
        temp.putString("method", "auth.expireSession");
        String s = request(temp);
    ...
    private Session userSetSession;
