    ...
    implements Serializable
{
    ...
    FacebookTimeSpentData(long l, long l1, long l2, int i,
            String s, SerializationProxyV1 _pcls1)
    {
        this(l, l1, l2, i, s);
    }
    ...
    private void logAppDeactivatedEvent(AppEventsLogger appeventslogger, long l)
    {
        ...
        bundle.putString("fb_mobile_time_between_sessions", String.format("session_quanta_%d", new Object[] {
    ...
    public void onResume(AppEventsLogger appeventslogger, long l, String s)
    {
        long l2;
    ...
    public void onSuspend(AppEventsLogger appeventslogger, long l)
    {
        if(!isAppActive)
        {
