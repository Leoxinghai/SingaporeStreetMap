...
public final class TintManager
{
    ...
    private static void setPorterDuffColorFilter(Drawable drawable, int i, android.graphics.PorterDuff.Mode mode)
    {
        ...
        {
            porterduffcolorfilter = new PorterDuffColorFilter(i, mode1);
            COLOR_FILTER_CACHE.put(i, mode1, porterduffcolorfilter);
        }
    ...
    public static void tintViewBackground(View view, TintInfo tintinfo)
    {
        ...
        if(tintinfo.mHasTintList)
        {
            ...
            if(tintinfo.mHasTintMode)
                tintMode = tintinfo.mTintMode;
            else
                tintMode = null;
            setPorterDuffColorFilter(drawable, i, tintMode);
        } else
        {
    ...
    public final ColorStateList getTintList(int i)
    {
        ...
        if(context != null) {
            ...
            if (i != android.support.v7.appcompat.R.drawable.abc_edit_text_material) {
                ...
                else if (i == android.support.v7.appcompat.R.drawable.abc_switch_thumb_material)
                    colorstatelist = createSwitchThumbColorStateList(context);
                else if (i == android.support.v7.appcompat.R.drawable.abc_btn_default_mtrl_shape || i == android.support.v7.appcompat.R.drawable.abc_btn_borderless_material)
                    colorstatelist = createButtonColorStateList(context);
                else if (i == android.support.v7.appcompat.R.drawable.abc_spinner_mtrl_am_alpha || i == android.support.v7.appcompat.R.drawable.abc_spinner_textfield_background_material)
