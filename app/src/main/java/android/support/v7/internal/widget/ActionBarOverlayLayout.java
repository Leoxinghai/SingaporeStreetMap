...
public class ActionBarOverlayLayout extends ViewGroup
    implements android.support.v7.widget.DecorContentParent, NestedScrollingParent
{
    ...
    {
        boolean flag5 = false;
        ActionBarOverlayLayout.LayoutParams layoutParams = (LayoutParams)view.getLayoutParams();
        boolean flag4 = flag5;
        if(flag)
        {
            flag4 = flag5;
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        {
            Rect rect = mContentInsets;
            rect.top = ((Rect) (rect)).top + k;
            //rect = mContentInsets;
            rect.bottom = ((Rect) (rect)).bottom + l;
        } else
        {
