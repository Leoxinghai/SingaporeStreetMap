...
abstract class AbsSpinnerCompat extends AdapterViewCompat
{
    ...
    public void onRestoreInstanceState(Parcelable parcelable)
    {
        ...
        if(((SavedState) (savedState)).selectedId >= 0L)
        {
            mDataChanged = true;
            mNeedSync = true;
            mSyncRowId = ((SavedState) (savedState)).selectedId;
            mSyncPosition = ((SavedState) (savedState)).position;
            mSyncMode = 0;
            requestLayout();
        }
    }
    ...
    public void setAdapter(SpinnerAdapter spinneradapter)
    {
        ...
        if(mAdapter != null)
        {
            ...
            checkFocus();
            mDataSetObserver = new AdapterViewCompat.AdapterDataSetObserver();
